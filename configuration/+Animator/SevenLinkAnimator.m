classdef SevenLinkAnimator < Animator.AbstractAnimator
    properties
        leg1Color = 'b';
        leg2Color = 'b';
        humanColor = 'k';
    ...
    methods
        function obj = SevenLinkAnimator(t, q, varargin)
            ...
            obj.pRFoot_RToe = line([0,0],[pR(1) pRToe(1)],[pR(3) pRToe(3)]);
            obj.pLFoot_LToe = line([0,0],[pL(1) pLToe(1)],[pL(3) pLToe(3)]);
            obj.pRFoot_RHeel = line([0,0],[pR(1) pRHeel(1)],[pR(3) pRHeel(3)]);
            obj.pLFoot_LHeel = line([0,0],[pL(1) pLHeel(1)],[pL(3) pLHeel(3)]);
            ...
            set(obj.pRKnee_RFoot,'LineWidth',3,'Color',obj.prostheticColor);
            set(obj.pLKnee_LFoot,'LineWidth',3,'Color',obj.leg2Color);
            set(obj.pRFoot_RToe,'LineWidth',3,'Color',obj.prostheticColor);
            set(obj.pLFoot_LToe,'LineWidth',3,'Color',obj.leg2Color);
            set(obj.pRFoot_RHeel,'LineWidth',3,'Color',obj.prostheticColor);
            set(obj.pLFoot_LHeel,'LineWidth',3,'Color',obj.leg2Color);
        ...
        function Draw(obj, t, x)
            ...
            set(obj.pRFoot_RToe,'YData',[pR(1) pRToe(1)],'ZData',[pR(3) pRToe(3)],'XData',[0 0]);
            set(obj.pLFoot_LToe,'YData',[pL(1) pLToe(1)],'ZData',[pL(3) pLToe(3)],'XData',[0 0]);
            set(obj.pRFoot_RHeel,'YData',[pR(1) pRHeel(1)],'ZData',[pR(3) pRHeel(3)],'XData',[0 0]);
            set(obj.pLFoot_LHeel,'YData',[pL(1) pLHeel(1)],'ZData',[pL(3) pLHeel(3)],'XData',[0 0]);
            set(obj.pHT,'YData',[pH(1) pT(1)],'ZData',[pH(3) pT(3)],'XData',[0 0]);
            
            delete(obj.text);
            obj.text = text(0,pH(1)-0.2,pH(3)+1,['t = ',sprintf('%.2f',t)]);
            obj.text.FontSize = 18;
